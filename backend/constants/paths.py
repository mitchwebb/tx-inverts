...
SHAPEFILE_PATHS = {
    ...
    # 'eco_l3':   os.path.join(base, 'tx_eco_l3.shp'), # These are currently only online (mapbox)
    # 'eco_l4':   os.path.join(base, 'tx_eco_l4.shp'), # These are currently only online (mapbox)
}
